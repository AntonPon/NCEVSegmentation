...
def train(args):
    ...
    t_loader = data_loader(data_path, is_transform=True, img_size=(512, 512), augmentations=data_aug, img_norm=args.img_norm)
    #v_loader = data_loader(data_path, is_transform=True, split='val', img_size=(args.img_rows, args.img_cols), img_norm=args.img_norm)
    v_loader = data_loader(data_path, is_transform=True, split='val', img_size=(512, 512), img_norm=args.img_norm)
